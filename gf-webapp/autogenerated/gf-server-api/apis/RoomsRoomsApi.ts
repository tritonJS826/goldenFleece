...
/**
 * RoomsRoomsApi - interface
 * 
 * @export
 * @interface RoomsRoomsApiInterface
 */
export interface RoomsRoomsApiInterface {
    /**
     * Retrieve a list of all rooms
     * @summary List of rooms
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof RoomsRoomsApiInterface
     */
 ...
 * 
 */
export class RoomsRoomsApi extends runtime.BaseAPI implements RoomsRoomsApiInterface {
